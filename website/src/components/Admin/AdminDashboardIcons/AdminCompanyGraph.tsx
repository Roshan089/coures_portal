...
export function AdminCompanyGraph() {
  const theme = useTheme();
  
  const { data: companyGraphData, isLoading } = useGetCompanyGraphQuery("hr");
  console.log("companyGraphData", companyGraphData);
  const chartData =
    companyGraphData?.planWiseRevenue.map((item) => ({
      ...
      >
        <Box>
          ...
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            >
              {(companyGraphData?.totalAmount || 0).toLocaleString("en-IN", {
