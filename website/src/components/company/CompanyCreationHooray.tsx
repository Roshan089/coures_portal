...
interface CompanyCreationHoorayProps {
  isOpen: boolean
  onClose: () => void
}

export function CompanyCreationHooray({ isOpen, onClose }: CompanyCreationHoorayProps) {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        >
          You have successfully {isOpen ? 'created' : 'updated'} your company!
        </Typography>
      </DialogContent>
