...
import { jobDetailsFormSchema, jobDetailsFormValues } from "../../../yup/jobDetailSchema";
const india = "IN";
const JobDetailsForm = () => {
  ...
  const userId = useSelector(
    (state: RootState) => state.auth.currentUser.user.userType.userId
  );
  ...
  // const [{ isLoading }] = useCreateJobDetailsMutation(); // Only keep `isLoading` if used
  ...
  const onSubmit = async (data: jobDetailsFormValues) => {
    ...
    router.push(AGENCY_ROUTES.CONFIRM_JOB_SETTING);
  };
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputField
                        ...
                        helperText={errors.minSalary?.message || (isNaN(field.value) ? "Min salary must be a number" : "")}
                        onChange={(e) => {
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <InputField
                        ...
                        helperText={errors.maxSalary?.message || (isNaN(field.value) ? "Max salary must be a number" : "")}
                        onChange={(e) => {
                          const value = e.target.value;
                          if (value === "" || /^\d+$/.test(value)) {
                            field.onChange(value === "" ? 0 : parseInt(value));
                ...
                <TextField
                  ...
                  sx={{
                    "& .MuiOutlinedInput-root": {
                      border: errors.skillsRequired ? "1px solid #d32f2f" : "1px solid #D1D9E9",
                      borderRadius: "4px",
                      height: "32px",
                      fontSize: "14px",
                      padding: "0 12px",
                      "&:hover": {
                        borderColor: errors.skillsRequired ? "1px solid #d32f2f" : "1px solid #D1D9E9",
                      },
                      "&.Mui-focused": {
                        borderColor: errors.skillsRequired ? "1px solid #d32f2f" : "1px solid #D1D9E9",
                      },
