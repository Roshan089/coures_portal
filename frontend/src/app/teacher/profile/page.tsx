      ...
      <div className="relative rounded-3xl bg-gradient-to-br from-[#242D3D] via-[#2d3849] to-[#354053] p-8 md:p-10 text-white shadow-xl overflow-hidden">
        ...
        <div className="relative flex flex-col sm:flex-row sm:items-center gap-6">
          ...
          <div className="min-w-0">
            ...
            <span className="inline-flex mt-4 px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wide bg-blue-500/30 text-blue-200 border border-blue-400/30">
              Teacher
            </span>
          </div>
        </div>
